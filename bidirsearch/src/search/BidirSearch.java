...
public class BidirSearch implements Iterator<MyTreeResult>{
  ...
  public List<List<Node>> getKeywordSet(){
    ...
    for (String entity : entities){
      ...
      entity="<"+entity.toLowerCase()+">"; // toLowerCase() to ensure compatibility. Angular brackets to match typical RDF node URIs.
      if(NametoNumMap.nameToNum.containsKey(entity)){ // Exact matching of node labels. May change to check partial matches.
