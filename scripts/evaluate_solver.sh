...
if [ ! -f ${input_file_with_hits} ] || [ "$retrain" == "true" ]; then
...
if [ ! -f ${input_file_as_entailment} ]  || [ "$retrain" == "true" ]; then
...
if [ ! -f ${input_file_as_entailment_with_struct} ]  || [ "$retrain" == "true" ]; then
...
if [ ! -f ${entailment_predictions} ]  || [ "$retrain" == "true" ]; then
...
# choice (using max)
if [ ! -f ${qa_predictions} ]  || [ "$retrain" == "true" ]; then
